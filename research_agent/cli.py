...
用法：
    uv run python -m research_agent.cli "帮我分析一下 outputs 目录下有哪些数据文件"
    uv run python -m research_agent.cli --session <id> "继续上次的话题"
    uv run python -m research_agent.cli --list          # 列出会话
"""
